...
def add_args(parser):
    parser.add_argument('--logdir', type=str, default='./reconstruction_results', help='log directory')
    ...
    parser.add_argument('--output_any', default=True)

    parser.add_argument('--loss_type', type=str, default='siren_w_morse')
    ...
    parser.add_argument('--loss_weights', nargs='+', type=float, default=[7e3, 6e2, 2e2, 5e1, 0, 10],
